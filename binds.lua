...
function Binds:init(position, scale, pivot, font)
    ...
    self:addBind("wheelright", vector(24.75, 0.25), vector(0.25, 1.5), "")
    self:addBind("mb4", vector(23, 2), vector(1, 1), "m4")
    self:addBind("mb5", vector(24, 2), vector(1, 1), "m5")
    self:addBind("mb6", vector(25, 2), vector(1, 1), "m6")
    self:addBind("mb7", vector(23, 3), vector(1, 1), "m7")
    self:addBind("mb8", vector(24, 3), vector(1, 1), "m8")
    self:addBind("mb9", vector(25, 3), vector(1, 1), "m9")
    self:addBind("mb10", vector(23, 4), vector(1, 1), "m10")
    self:addBind("mb11", vector(24, 4), vector(1, 1), "m11")
    self:addBind("mb12", vector(25, 4), vector(1, 1), "m12")
